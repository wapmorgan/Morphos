...
class GeneralDeclensionTest extends \PHPUnit_Framework_TestCase {
    ...
    public function wordsProvider() {
        return array(
            // 1 - Мужской рода с нулевым или окончанием [о, е],
            // 1 - Среднего рода с окончанием [о, е].
            // 2 - Женский, мужской род с окончанием [а, я].
            ...
            array('рубль', false, 1, array('рубль', 'рубля', 'рублю', 'рубль', 'рублем', 'о рубле')),
            array('доллар', false, 1, array('доллар', 'доллара', 'доллару', 'доллар', 'долларом', 'о долларе')),
            array('евро', false, 1, array('евро', 'евро', 'евро', 'евро', 'евро', 'о евро')),
            array('фунт', false, 1, array('фунт', 'фунта', 'фунту', 'фунт', 'фунтом', 'о фунте')),
            ...
            array('гривна', false, 2, array('гривна', 'гривны', 'гривне', 'гривну', 'гривной', 'о гривне')),
