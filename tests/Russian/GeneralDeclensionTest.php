...
class GeneralDeclensionTest extends \PHPUnit_Framework_TestCase {
    ...
    public function wordsProvider() {
        return array(
            ...
            array('сообщение', false, 2, array('сообщение', 'сообщения', 'сообщению', 'сообщение', 'сообщением', 'о сообщение')),
            array('общение', false, 2, array('общение', 'общения', 'общению', 'общение', 'общением', 'об общение')),
            array('воскрешение', false, 2, array('воскрешение', 'воскрешения', 'воскрешению', 'воскрешение', 'воскрешением', 'о воскрешение')),
