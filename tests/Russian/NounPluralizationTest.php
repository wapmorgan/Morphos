...
class NounPluralizationTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function pluralWordsProvider()
    {
        return array(
            ...
            array('халат', false, array('халаты', 'халатов', 'халатам', 'халаты', 'халатами', 'о халатах')),
            array('прожектор', false, array('прожекторы', 'прожекторов', 'прожекторам', 'прожекторы', 'прожекторами', 'о прожекторах')),
