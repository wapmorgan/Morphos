...
class NounPluralizationTest extends TestCase
{
    ...
    public function pluralWordsProvider()
    {
        return [
            ...
            ['руководитель', true, ['руководители', 'руководителей', 'руководителям', 'руководителей', 'руководителями', 'руководителях']],

            // Адъективное склонение
            // мужской род
            ['выходной', false, ['выходные', 'выходных', 'выходным', 'выходные', 'выходными', 'выходных']],
            ['двугривенный', false, ['двугривенные', 'двугривенных', 'двугривенным', 'двугривенные', 'двугривенными', 'двугривенных']],
            ...
            ['подлежащее', false, ['подлежащие', 'подлежащих', 'подлежащим', 'подлежащие', 'подлежащими', 'подлежащих']],
            // женский род
